  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">DasinAQ?</span>
      </h1>
      
      <br />
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
        <b>Welcome to Your Learning Hub</b>
        <br /><br />

        Our platform is dedicated to helping students excel in their Polytechnic courses 
        and BPSC exam preparation. We offer comprehensive classes in key 
        Polytechnic disciplines like Electrical, Civil, Electronics & Communication,
         and Computer Engineering. For BPSC aspirants, we provide specialized classes 
         in Science and Technology, as well as Bihar-focused current affairs, 
         ensuring you’re well-prepared for every challenge.
          {/* Are you ready to take your programming skills to the next level? Look
          no further than DasinAQ, the premier programming community dedicated
          to helping new programmers achieve their goals and reach their full
          potential. */}
          <br />
          <br />
          {/* As the founder and CEO of DasinAQ, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created DasinAQ &ndash; to provide new programmers
          ...
          <br />
          <br />
          {/* At DasinAQ, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          {/* But DasinAQ is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          {/* With DasinAQ by your side, there&apos;s nothing standing between you
          ...
          <br />
          <br />
          {/* So what are you waiting for? Join the DasinAQ family today and let&apos;s
        ...
        <br />
        <span className="text-[22px]">Amit</span>
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of DasinAQ
        </h5>
        <br />
        <br />
        <br />
